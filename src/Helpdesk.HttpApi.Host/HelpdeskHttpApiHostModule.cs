...
public class HelpdeskHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<HelpdeskDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Helpdesk.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<HelpdeskDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Helpdesk.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<HelpdeskApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Helpdesk.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<HelpdeskApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Helpdesk.Application"));
            });
        }
    }
    ...
    {
        context.Services.AddHelpdeskHealthChecks();
    }
    ...
    public override async System.Threading.Tasks.Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await context.AddBackgroundWorkerAsync<Helpdesk.BackgroundWorkers.AutomationPeriodicWorker>();
