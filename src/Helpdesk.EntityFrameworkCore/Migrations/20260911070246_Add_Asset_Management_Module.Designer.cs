...
namespace Helpdesk.Migrations
{
    ...
    [Migration("20260911070246_Add_Asset_Management_Module")]
    partial class Add_Asset_Management_Module
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Helpdesk.Assets.Asset", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Assets.AssetActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAssetActivities", (string)null);
                });

            modelBuilder.Entity("Helpdesk.AssignmentRules.AssignmentRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DirectAssigneeId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAssignmentRules", (string)null);
                });

            modelBuilder.Entity("Helpdesk.AssignmentRules.AssignmentRuleAgent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RuleId", "UserId")
                        .IsUnique();

                    b.ToTable("AppAssignmentRuleAgents", (string)null);
                });

            modelBuilder.Entity("Helpdesk.Automations.AutomationRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAutomationRules", (string)null);
                });

            modelBuilder.Entity("Helpdesk.Automations.Macro", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMacros", (string)null);
                });

            modelBuilder.Entity("Helpdesk.CannedResponses.CannedResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppCannedResponses", (string)null);
                });

            modelBuilder.Entity("Helpdesk.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.KnowledgeBase.KnowledgeArticle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Priorities.Priority", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Sla.BusinessHour", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppBusinessHours", (string)null);
                });

            modelBuilder.Entity("Helpdesk.Sla.Holiday", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Sla.SlaBreachLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("ResolvedOrRespondedAt")
                        .HasColumnType("timestamp without time zone");

                    b.Property<Guid?>("SlaPolicyRuleId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSlaBreachLogs", (string)null);
                });

            modelBuilder.Entity("Helpdesk.Sla.SlaPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSlaPolicies", (string)null);
                });

            modelBuilder.Entity("Helpdesk.Sla.SlaPolicyRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("EscalateToDepartmentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SlaPolicyId", "PriorityId", "CategoryId");

                    b.ToTable("AppSlaPolicyRules", (string)null);
                });

            modelBuilder.Entity("Helpdesk.TicketSources.TicketSource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppTicketSources", (string)null);
                });

            modelBuilder.Entity("Helpdesk.TicketStatuses.TicketStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppTicketStatuses", (string)null);
                });

            modelBuilder.Entity("Helpdesk.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AiSentimentReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<DateTime?>("FirstResponseDueDate")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Helpdesk.Tickets.TicketActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Tickets.TicketAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Tickets.TicketComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Helpdesk.Assets.AssetActivity", b =>
                {
                    b.HasOne("Helpdesk.Assets.Asset", null)
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("Helpdesk.AssignmentRules.AssignmentRuleAgent", b =>
                {
                    b.HasOne("Helpdesk.AssignmentRules.AssignmentRule", null)
                        .WithMany("RuleAgents")
            ...
            modelBuilder.Entity("Helpdesk.Categories.Category", b =>
                {
                    b.HasOne("Helpdesk.Categories.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Helpdesk.Sla.SlaPolicyRule", b =>
                {
                    b.HasOne("Helpdesk.Sla.SlaPolicy", null)
                        .WithMany("Rules")
